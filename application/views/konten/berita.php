...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        <a class="navbar-brand" href="index.html"><!-- <i class="flaticon-cross"></i> --><img src="<?php echo base_url();?>assets/wisdom/images/logoGKJ1.png" height="30" width="30"> <span>Gereja Kristen Pasundan</span></a>
      ...
      <!--   <div class="row mb-5">
          <div class="col-md"> -->
            <div class="ftco-footer-widget mb-4">
              <h2 class="logo"><img src="<?php echo base_url();?>assets/wisdom/images/logoGKJ1.png" height="30" width="30"> <a href="index.html"></i><span>Gereja Kristen Pasundan</span></a></h2>

              <br>
                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
   Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | GKP <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">SLS</a>
