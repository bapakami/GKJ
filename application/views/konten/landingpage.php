...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="<?php echo base_url();?>index.html"><!-- <i class="flaticon-cross"></i> --><img src="<?php echo base_url();?>assets/wisdom/images/logoGKJ1.png" height="30" width="30"> <span>Gereja Kristen Pasundan</span></a>
            ...
            <div class="row">
              <div class="col-md-12 d-md-flex">
                <div class="one-forth ftco-animate">
                  <img src="assets/wisdom/images/logoGKJ1.png"  height="30" width="30">
